...
Revision ID: 207bc050c1e0
Revises: 
Create Date: 2023-07-14 16:31:52.749089
...
def upgrade() -> None:
    ...
    sa.Column('json_data', sa.String(length=500), nullable=True),
    sa.Column('form_data', sa.String(length=500), nullable=True),
